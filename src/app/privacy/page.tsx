...
const PRIVACY_POINTS = [
  {
    icon: ShieldCheck,
    title: "Local-first di default",
    body:
      "Il percorso principale di Numa resta locale: lettura, organizzazione dei movimenti e calcoli vivono sul dispositivo che stai usando."
  },
  {
    icon: WalletCards,
  ...
  {
    icon: HardDrive,
    title: "Continuità sotto il tuo controllo",
    body:
      "Se cambi browser o dispositivo, i dati non si sincronizzano in automatico. Oggi il passaggio corretto è export locale e restore del backup."
  }
] as const

export const metadata: Metadata = {
  title: "Privacy | Numa Budget",
  description: "Come funziona il modello local-first di Numa Budget: dati nel browser, backup locale e limiti attuali di continuità tra dispositivi."
}
      ...
      <div className="space-y-6">
        <section className="glass-panel rounded-[2.5rem] border-none p-6 shadow-[0_24px_70px_-42px_rgba(15,23,42,0.34)] sm:p-8">
          ...
          <h1 className="mt-4 max-w-[14ch] text-4xl font-black leading-[0.96] tracking-tight text-foreground sm:text-5xl">
            Un perimetro chiaro prima di qualsiasi promessa.
          </h1>
          <p className="mt-4 max-w-[44rem] text-base font-medium leading-relaxed text-muted-foreground sm:text-lg">
            Numa nasce per leggere il mese con più chiarezza senza trasformare il tuo quadro finanziario in un dato da affidare subito a un servizio remoto.
          </p>
        </section>
          ...
          <div className="space-y-5">
            <div className="space-y-2">
              ...
              <p className="max-w-[42rem] text-sm font-medium leading-relaxed text-muted-foreground sm:text-base">
                Questa non è una pagina legale estesa. È la sintesi operativa di come si comporta il prodotto nel suo percorso principale attuale.
              </p>
            </div>
            ...
            <div className="space-y-4 text-sm font-medium leading-relaxed text-muted-foreground sm:text-base">
              ...
              <p>
                Le integrazioni remote presenti nel codice non sono la baseline del prodotto pubblico: il comportamento di default resta local-first e prudente.
              </p>
            </div>
          </div>
        </section>
