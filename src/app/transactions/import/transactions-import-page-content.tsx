...
export function TransactionsImportPageContent() {
  ...
  return (
    <StaggerContainer className="space-y-6 w-full">
      <motion.div variants={macroItemVariants}>
        <PageHeader
          title="Importa CSV"
          description="Carica il file della banca, prova il dataset demo e controlla i movimenti prima di aggiungerli."
        />
      </motion.div>
